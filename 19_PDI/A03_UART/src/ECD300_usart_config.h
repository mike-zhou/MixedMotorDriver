...
//select the length of buffers, should be one of 0x03ff, 0x1ff, 0xff, 0x7f, 0x3f, 0x1f, 0xf, 0x7, 0x3.
...
#define ECD300_UART1_INT_TRANSMIT_BUFFER_LENGTH 	0xff
//the level can be 0x1(low), 0x2(medium), 0x3(high)
...
//select the length of buffers, should be one of 0xff, 0x7f, 0x3f, 0x1f, 0xf, 0x7, 0x3.
#define ECD300_UART2_INT_RECEIVE_BUFFER_LENGTH 		0x1f
