...
short ecd300ReadNandPageEx(unsigned char planeAddress, 
								...
								bool bWait)
{
	return ecd300ReadNandPage(planeAddress,
								(blockAddress<<6)|(pageAddress&0x3F),
								colAddress,
								pBuffer,
								amount,
								bWait);
...
short ecd300ProgramNandPageEx(unsigned char planeAddress, 
								...
								bool bWait)
{
	return ecd300ProgramNandPage(planeAddress,
								(blockAddress<<6)|(pageAddress&0x3F),
								colAddress,
								pBuffer,
								amount, 
...
short ecd300EraseNandBlockEx(unsigned char planeAddress,
						...
						bool bWait)
{
	return ecd300EraseNandBlock(planeAddress,
								blockAddress<<6,
								bWait);
}
